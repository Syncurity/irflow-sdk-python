...
# -*- coding: utf-8 -*-
#
# Syncurity SDK documentation build configuration file, created by
...
project = 'Syncurity SDK'
copyright = '2017, Syncurity'
author = 'Syncurity'
...
latex_documents = [
    (master_doc, 'SyncuritySDK.tex', 'Syncurity SDK Documentation',
     'Syncurity', 'manual'),
]
